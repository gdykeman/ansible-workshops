...
====
*Step 1:* From the view pane on the left, select *Credentials* under RESOURCES     image:3.3_credentials.png[Gear,35,25] +

*Step 2:* Click the *plus* sign towards the top right  image:at_plus.png[plus,20,20] +
...
====
*Step 1:* From the view pane on the left, select *Projects* under Resources image:at_projects.png[Gear,35,25]+

*Step 2:* Click the *plus* sign towards the top right and select *Inventory*  image:3.3_projects.png[plus,20,20] +
...
====
*Step 1:* From the view pane on the left, select *Inventories* under Resources image:3.3_inventories.png[Gear,35,25]+
